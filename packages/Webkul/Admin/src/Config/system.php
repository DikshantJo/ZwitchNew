...
return [
    ...
    [
        ...
        'key'    => 'general.design.frontend_theme',
        'name'   => 'admin::app.configuration.index.general.design.frontend-theme.title',
        'info'   => 'admin::app.configuration.index.general.design.frontend-theme.title-info',
        'sort'   => 3,
        'fields' => [
            [
                'name'    => 'mode',
                'title'   => 'admin::app.configuration.index.general.design.frontend-theme.mode',
                'type'    => 'select',
                'default' => 'light',
                'options' => [
                    [
                        'title' => 'admin::app.configuration.index.general.design.frontend-theme.light-mode',
                        'value' => 'light',
                    ], [
