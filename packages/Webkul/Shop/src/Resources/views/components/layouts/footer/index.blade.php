    ...
    <div class="flex justify-between items-start px-[162px] md-pt-[100px] py-[50px] max-xl:px-16 max-lg:px-8 max-md:flex-col max-md:gap-8 max-md:px-6 max-sm:px-4">
        ...
        <div class="flex flex-col gap-6 max-md:gap-4" style="align-items: flex-start;">
            ...
            <div class="flex gap-5 max-sm:gap-3 mt-8 max-md:mt-6">
                <!-- Facebook -->
                <a href="https://www.facebook.com/profile.php?id=61563195875707" target="_blank" rel="noopener noreferrer" class="bg-[#ffffff] p-4 rounded-xl max-sm:p-3 hover:bg-gray-100 transition-colors duration-200" style='background-color: #ffffff;'>
                ...
                <!-- Instagram -->
                <a href="https://www.instagram.com/getzwitched/" target="_blank" rel="noopener noreferrer" class="bg-[#ffffff] p-4 rounded-xl max-sm:p-3 hover:bg-gray-100 transition-colors duration-200" style='background-color: #ffffff;'>
                    <div class="w-[34px] h-[34px] flex items-center justify-center max-sm:w-[28px] max-sm:h-[28px]">
                        <svg class="w-full h-full" fill="#000000" viewBox="0 0 24 24" aria-hidden="true" style="color: #000000 !important;">
                ...
                <a href="https://www.linkedin.com/in/zwitch-originals-58964235b/" target="_blank" rel="noopener noreferrer" class="bg-[#ffffff] p-4 rounded-xl max-sm:p-3 hover:bg-gray-100 transition-colors duration-200" style='background-color: #ffffff;'>
                    <div class="w-[34px] h-[34px] flex items-center justify-center max-sm:w-[28px] max-sm:h-[28px]">
                        <svg class="w-full h-full" fill="#000000" viewBox="0 0 24 24" aria-hidden="true" style="color: #000000 !important;">
                ...
                <!-- YouTube -->
                <a href="https://www.youtube.com/@ZwitchOriginals" target="_blank" rel="noopener noreferrer" class="bg-[#ffffff] p-4 rounded-xl max-sm:p-3 hover:bg-gray-100 transition-colors duration-200" style='background-color: #ffffff;'>
                    <div class="w-[34px] h-[34px] flex items-center justify-center max-sm:w-[28px] max-sm:h-[28px]">
                        <svg class="w-full h-full" fill="#000000" viewBox="0 0 24 24" aria-hidden="true" style="color: #000000 !important;">
