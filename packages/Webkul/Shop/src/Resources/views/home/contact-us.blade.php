...
<x-shop::layouts>
    ...
    <div class="container mt-8 max-1180:px-5 max-md:mt-6 max-md:px-4">
        <!-- Form Container -->
		<div class="m-auto w-full max-w-[870px] rounded-xl border border-zinc-200 dark:border-gray-600 bg-white dark:bg-gray-800 p-16 px-[90px] max-md:px-8 max-md:py-8 max-sm:border-none max-sm:p-0">
			<h1 class="text-4xl max-md:text-3xl max-sm:text-xl text-gray-900 dark:text-white">
                @lang('shop::app.home.contact.title')
            </h1>

			<p class="mt-4 text-xl text-zinc-500 dark:text-gray-300 max-sm:mt-1 max-sm:text-sm">
                @lang('shop::app.home.contact.about')
            </p>

            <div class="mt-14 rounded max-sm:mt-8">
                <!-- Contact Form -->
                <x-shop::form :action="route('shop.home.contact_us.send_mail')" class="dark:bg-gray-800">
                    <!-- Name -->
                    ...
                    @if (core()->getConfigData('customer.captcha.credentials.status'))
                        <div class="mb-5 flex dark:bg-gray-700 dark:p-4 dark:rounded-lg">
                    ...
                    <div class="mt-8 flex flex-wrap items-center gap-9 max-sm:justify-center max-sm:text-center">
                        <button
                            class="primary-button m-0 mx-auto block w-full max-w-[374px] rounded-2xl px-11 py-4 text-center text-base max-md:max-w-full max-md:rounded-lg max-md:py-3 max-sm:py-1.5 ltr:ml-0 rtl:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:text-white"
                            type="submit"
                        >
