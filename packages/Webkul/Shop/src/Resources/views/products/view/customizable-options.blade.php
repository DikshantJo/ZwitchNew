            ...
            <script type="module">
                ...
                app.component('v-product-customizable-option-item', {
                    ...
                    mounted() {
                        ...
                        // Auto-select first option for radio and select types
                        this.$nextTick(() => {
                    ...
                    methods: {
                        ...
                        autoSelectFirstOption() {
                            if (this.option.type === 'radio' && this.optionItems.length > 0) {
                                // For radio buttons, select the first option (skip "None" if not required)
                                const firstOption = this.option.is_required ? this.optionItems[0] : this.optionItems[0];
                                if (firstOption) {
                                    this.selectedItems = firstOption.id;
                                }
                            } else if (this.option.type === 'select' && this.optionItems.length > 0) {
                                // For select dropdowns, select the first option
